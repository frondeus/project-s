...
N17 [label="17: Var"];
N18 [label="18: Use(UList { items: Use(17), min_len: 0, max_len: None })"];
N19 [label="19: Value(VList { item: Value(17) })"];
N20 [label="20: Value(VFunc { pattern: Use(18), ret: Value(19) })"];
N21 [label="21: Value(VNumber)"];
N22 [label="22: Value(VNumber)"];
N23 [label="23: Value(VNumber)"];
N24 [label="24: Var"];
N25 [label="25: Use(UNumber)"];
N26 [label="26: Use(UTuple { items: [Use(25)] })"];
N27 [label="27: Value(VTuple { items: [Value(21), Value(22), Value(23)] })"];
N28 [label="28: Use(UApplication { args: Value(27), ret: Use(24), index: (Some(1), Use(26)) })"];
N29 [label="29: Value(VTuple { items: [] })"];
START -> N13
...
N19 -> N17 [color=blue, style=dotted];
N20 -> N18 [color=blue, style=dotted];
N20 -> N19 [color=blue, style=dotted];
N26 -> N25 [color=red, style=dotted];
N27 -> N21 [color=blue, style=dotted];
N27 -> N22 [color=blue, style=dotted];
N27 -> N23 [color=blue, style=dotted];
N28 -> N27 [color=red, style=dotted];
N28 -> N24 [color=red, style=dotted];
N28 -> N26 [color=red, style=dotted];
N17 -> N15;
N17 -> N14;
N17 -> N13;
N19 -> N24;
