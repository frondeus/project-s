...
N35 [label="35: Value(VLiteral(Number(5.0)))"];
N36 [label="36: Use(UPrimitive("number"))"];
N37 [label="37: Value(VLiteral(Number(3.0)))"];
N38 [label="38: Use(UPrimitive("number"))"];
N39 [label="39: Var"];
N40 [label="40: Value(VTuple { items: [] })"];
N41 [label="41: Value(VLiteral(Bool(true)))"];
N42 [label="42: Use(UPrimitive("bool"))"];
N43 [label="43: Use(UPrimitive("bool"))"];
N44 [label="44: Value(VLiteral(Number(5.0)))"];
N45 [label="45: Use(UPrimitive("number"))"];
N46 [label="46: Value(VLiteral(Number(3.0)))"];
N47 [label="47: Use(UPrimitive("number"))"];
N48 [label="48: Var"];
START -> N48
...
N39 [label="39: Var"];
N40 [label="40: Value(VTuple { items: [] })"];
N41 [label="41: Value(VLiteral(Bool(false)))"];
N42 [label="42: Use(UPrimitive("bool"))"];
N43 [label="43: Use(UPrimitive("bool"))"];
N44 [label="44: Value(VLiteral(String("string")))"];
N45 [label="45: Use(UPrimitive("string"))"];
N46 [label="46: Value(VLiteral(String("string")))"];
N47 [label="47: Use(UPrimitive("string"))"];
N48 [label="48: Var"];
N49 [label="49: Value(VTuple { items: [] })"];
N50 [label="50: Value(VLiteral(Bool(true)))"];
N51 [label="51: Use(UPrimitive("bool"))"];
N52 [label="52: Use(UPrimitive("bool"))"];
N53 [label="53: Value(VLiteral(Number(5.0)))"];
N54 [label="54: Use(UPrimitive("number"))"];
N55 [label="55: Value(VLiteral(Number(5.0)))"];
N56 [label="56: Use(UPrimitive("number"))"];
N57 [label="57: Var"];
START -> N57
N1 -> N0 [color=red, style=dotted];
N3 -> N1 [color=blue, style=dotted];
