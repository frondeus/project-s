...
N38 [label="38: Var"];
N39 [label="39: Value(VTuple { items: [Value(32), Value(34), Value(36)] })"];
N40 [label="40: Use(UApplication { args: Value(39), ret: Use(38), first_arg: Some(Value(32)) })"];
...
N39 -> N32 [color=blue, style=dotted];
N39 -> N34 [color=blue, style=dotted];
N39 -> N36 [color=blue, style=dotted];
N40 -> N39 [color=red, style=dotted];
N40 -> N38 [color=red, style=dotted];
N40 -> N32 [color=red, style=dotted];
N28 -> N26;
N28 -> N25;
N28 -> N24;
N30 -> N38;
