...
N36 [label="36: Use(UKeyword)"];
N37 [label="37: Use(UTuple { items: [Use(36)] })"];
N38 [label="38: Value(VTuple { items: [Value(30), Value(31), Value(32)] })"];
N39 [label="39: Use(UApplication { args: Value(38), ret: Use(33), field: (None, Use(37)), index: (Some(1), Use(35)) })"];
N40 [label="40: Value(VTuple { items: [] })"];
START -> N22
...
N38 -> N30 [color=blue, style=dotted];
N38 -> N31 [color=blue, style=dotted];
N38 -> N32 [color=blue, style=dotted];
N39 -> N38 [color=red, style=dotted];
N39 -> N33 [color=red, style=dotted];
N39 -> N37 [color=red, style=dotted];
N39 -> N35 [color=red, style=dotted];
N26 -> N24;
N26 -> N23;
N26 -> N22;
N28 -> N33;
