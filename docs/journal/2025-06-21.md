...
N33 [label="33: Value(VNumber)"];
N34 [label="34: Value(VNumber)"];
N35 [label="35: Var"];
N36 [label="36: Use(UNumber)"];
N37 [label="37: Use(UTuple { items: [Use(36)] })"];
N38 [label="38: Use(UKeyword)"];
N39 [label="39: Use(UTuple { items: [Use(38)] })"];
N40 [label="40: Value(VTuple { items: [Value(32), Value(33), Value(34)] })"];
N41 [label="41: Use(UApplication { args: Value(40), ret: Use(35), field: (None, Use(39)), index: (Some(1), Use(37)) })"];
N42 [label="42: Value(VTuple { items: [] })"];
START -> N24
...
N40 -> N32 [color=blue, style=dotted];
N40 -> N33 [color=blue, style=dotted];
N40 -> N34 [color=blue, style=dotted];
N41 -> N40 [color=red, style=dotted];
N41 -> N35 [color=red, style=dotted];
N41 -> N39 [color=red, style=dotted];
N41 -> N37 [color=red, style=dotted];
N28 -> N26;
N28 -> N25;
N28 -> N24;
N30 -> N35;
