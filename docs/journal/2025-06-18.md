...
N35 [label="35: Value(VLiteral(Bool(true)))"];
N36 [label="36: Use(UPrimitive("bool"))"];
N37 [label="37: Use(UPrimitive("bool"))"];
N38 [label="38: Value(VLiteral(Number(1.0)))"];
N39 [label="39: Use(UPrimitive("number"))"];
N40 [label="40: Var"];
N41 [label="41: Value(VFunc { pattern: Use(34), ret: Value(40) })"];
START -> N41
...
N41 -> N34 [color=blue, style=dotted];
N41 -> N40 [color=blue, style=dotted];
N33 -> N40;
N35 -> N36;
N35 -> N37;
N38 -> N39;
