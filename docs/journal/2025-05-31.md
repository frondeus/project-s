...
```lift
(top-level (let :top (fn () (do (let :c 42) (cl (:a :b) (c) (+ a b c))))) ((top) 1 2))
```
...
```lift
(top-level (let :c 42) (cl () (c) (let :d 10 (+ c d))))
```
...
```lift
(top-level (((obj/struct :a 42 :b (fn () (self :a))) :b)))
```
...
```lift
(top-level ((((obj/struct :a 42 :b (obj/struct :c (fn () (root :a)))) :b) :c)))
```
